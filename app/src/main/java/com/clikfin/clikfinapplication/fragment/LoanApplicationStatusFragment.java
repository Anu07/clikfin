...
public class LoanApplicationStatusFragment extends Fragment {
    TextView tvLoanApplicationStatusDescription, tvLoanStatusHeader,underReviewTv;
...
//        }
    ...
    private void fragmentNavigation() {
        ...
        if (loanApplicationStatus.equalsIgnoreCase(getString(R.string.under_review))) {
            ...
            underReviewTv.setVisibility(View.VISIBLE);
            ...
            tvLoanStatusHeader.setText(getString(R.string.rejected));
